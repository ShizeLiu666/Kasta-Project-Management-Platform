      ...
      >
        ...
        >
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            <img
              src={require('../../../../../../assets/icons/DeviceType/RB02.png')}
              alt="Battery Powered Remote Switch"
            ...
            <Table size="medium">
              ...
              <TableBody>
                {processedDevices.map((device, deviceIndex) => {
                  // RB02 设备通常只有一个绑定
                  const binding = device.specificAttributes?.remoteBind?.[0] || null;
...
export default React.memo(RB02); 